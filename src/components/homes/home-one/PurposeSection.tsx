            ...
            <div className="row">
               <div className="col-12">
                  <div className="tg-listing-section-title text-center mb-35">
                    <h2 className="mb-15 wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".6s">Find Your Perfect Journey, Whatever Your Purpose</h2>
                     <h5 className="tg-section-subtitle wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".5s">Whether you’re traveling with family, celebrating love, seeking adventure, or on a spiritual quest. <br></br> We have the perfect package for every purpose</h5>
                  </div>
               </div>
