...
const tabs = [
  { id: 7, title: "Family" },
  { id: 9, title: "Honeymoon" },
  { id: 8, title: "Vacation" },
  { id: 10, title: "Business" },
  { id: 11, title: "Adventure" },
  { id: 12, title: "Pilgrimage" },
];
  ...
  {openModal && selected && (
    ...
    <section className="container mx-auto py-10">
        ...
        <div className="col-12">
          ...
          <div className="tg-listing-section-title text-center mb-35">
            ...
            >
              ...
              adventure, or on a spiritual quest. <br></br> We have the perfect
              package for every purpose{" "}
            </p>{" "}
          </div>{" "}
        </div>{" "}
      </div>
      ...
      {!loading && listingData.length > 0 && (
        <Swiper {...slider} modules={[Autoplay, Navigation]} className="mukul">
          {(listingData ?? [])
            .slice(0, 10) // limit 10
            .map((item) => (
