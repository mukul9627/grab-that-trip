            ...
            <div className="row justify-content-center">
               <div className="col-lg-10">
                  <div className="tg-listing-section-title-wrap text-center mb-40">
                                         <h2 className="tg-section-su-title text-capitalize wow fadeInUp mb-15" data-wow-delay=".5s" data-wow-duration=".9s">Find Your Perfect Journey, Whatever Your Purpose</h2>
 <p className="home-second-p-color mb-10 ">
              Whether you’re traveling with family, celebrating love, seeking adventure, <br></br> or on a spiritual quest.
We have the perfect package for every purpose
            </p>                  </div>
               </div>
            </div>
            <div className="row">
