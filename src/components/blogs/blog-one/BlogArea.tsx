...
const BlogArea = () => {
  ...
  const [active, setActive] = useState("blog"); // default active

  if (loading) return <p className="text-center">Loading blogs...</p>;
  if (error) return <p className="text-center text-danger">{error}</p>;
  if (!blogList.length) return <p className="text-center">No blogs found</p>;
  ...
  return (
    <>
      ...
      <div className="col-xl-12 col-lg-8">
        <div className="row">
          <div className="col-xl-6 col-lg-12 col-md-6 blog-button">
            <div
              className={`blog-button-div ${
                active === "blog" ? "active" : ""
              }`}
          ...
          <div className="col-xl-6 col-lg-12 col-md-6 news-button">
            <div
              className={`news-button-div ${
                active === "news" ? "active" : ""
              }`}
                  ...
                  {currentItems.map((item) => (
                    ...
                    >
                      <div className="tg-blog-grid-item mb-30">
                        ...
                        <Link href={`/blog/${item.slug}`} className="tg-btn">
