   ...
   return (
      <>
         <header className="tg-header-height">
            <div className={`tg-header__area tg-header-tu-menu tg-header-lg-space z-index-999 homeone-header-p tg-transparent  ${sticky ? "header-sticky" : ""}`} style={{padding: "26px"}} id="header-sticky">
                     ...
                     <div className="col-xxl-9 col-xl-8 col-lg-8 col-3">
                        <div className="tgmenu__wrap d-flex align-items-center">
                           <div className="logo mr-25">
                              <Link className="logo-1" href="/"><Image style={{width: "90px", height: "77px"}} src={logo_1} alt="Logo" /></Link>
                              <Link className="logo-2 d-none" href="/"><Image style={{width: "90px", height: "77px"}} src={logo_2} alt="Logo" /></Link>
                           </div>
